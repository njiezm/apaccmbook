...
<head>
    ...
    <?php else: ?>
        ...
        <meta property="og:title" content="<?php echo $__env->yieldContent('title', 'APACC-M e-Livre'); ?>">
        <meta property="og:description" content="Bibliothèque numérique de l'APACC-M — patrimoine culturel et religieux martiniquais">
        <meta property="og:image" content="<?php echo e(asset('icons/icon-512x512.png')); ?>">
        <meta property="og:url" content="<?php echo e(url()->current()); ?>">
        <meta name="twitter:card" content="summary_large_image">
    <?php endif; ?>

    <link rel="icon" href="<?php echo e(asset('icons/icon.svg')); ?>" type="image/svg+xml">
    <link rel="alternate icon" href="<?php echo e(asset('icons/favicon-32.png')); ?>" type="image/png">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/apacc-m.css')); ?>?v=<?php echo e(@filemtime(public_path('css/apacc-m.css')) ?: '1'); ?>">
...
<nav class="site-navbar" role="navigation" aria-label="Navigation principale">
    <div class="navbar-inner">
        ...
        <ul class="nav-links" role="list">
            ...
            <li><a class="nav-link<?php echo e(request()->routeIs('wishlist.index') ? ' active' : ''); ?>" href="<?php echo e(route('wishlist.index')); ?>">Mes envies</a></li>
        ...
        <div class="nav-actions">
            ...
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('profile.edit')); ?>" class="nav-user<?php echo e(request()->routeIs('profile.edit') ? ' active' : ''); ?>" style="text-decoration:none;display:inline-flex;align-items:center;gap:0.4rem;" title="Mon profil">
                    <?php if(Auth::user()->avatar_path): ?>
                        <img src="<?php echo e(asset('storage/' . Auth::user()->avatar_path)); ?>" alt="" style="width:24px;height:24px;border-radius:50%;object-fit:cover;">
                    <?php else: ?>
...
<aside class="mobile-drawer" id="mobile-drawer" role="dialog" aria-modal="true" aria-label="Menu de navigation">
    ...
    <div class="drawer-user">
        <?php if(Auth::user()->avatar_path): ?>
            <img src="<?php echo e(asset('storage/' . Auth::user()->avatar_path)); ?>" alt="" class="drawer-avatar" style="object-fit:cover;">
        <?php else: ?>
    ...
    <nav class="drawer-nav" aria-label="Navigation mobile">
        ...
        <a href="<?php echo e(route('wishlist.index')); ?>" class="drawer-link<?php echo e(request()->routeIs('wishlist.index') ? ' drawer-link--active' : ''); ?>">
...
<div x-data="{ show: false }" x-init="show = !localStorage.getItem('cookieConsent')" x-cloak x-show="show"
    ...
    <span style="max-width:640px;line-height:1.5;">
        ...
        <a href="<?php echo e(route('privacy')); ?>" style="color:#fff;text-decoration:underline;">En savoir plus</a>.
    </span>
