<?php $__env->startSection('title', 'Confidentialité — APACC-M'); ?>
...
<div class="container-custom" style="padding-top:3rem;padding-bottom:5rem;max-width:800px;">
    <div style="background:var(--white);border:1px solid var(--border-light);border-radius:var(--radius-md);padding:2.5rem;box-shadow:var(--shadow-soft);">
        ...
        <p style="color:var(--text-secondary);line-height:1.8;margin-bottom:0;">Pour toute question relative à vos données personnelles, contactez-nous via le <a href="<?php echo e(route('contact')); ?>" style="color:var(--cardinal);">formulaire de contact</a>.</p>
    </div>
</div>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\apacc-m-ebook\resources\views/pages/privacy.blade.php ENDPATH**/ ?>