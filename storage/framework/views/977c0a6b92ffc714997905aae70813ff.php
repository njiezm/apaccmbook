...
<div class="admin-page" x-data="{
    ...
    <aside class="admin-sidebar">
        ...
        <nav class="admin-sidebar-nav">
            ...
            <button class="admin-sidebar-item" :class="{ active: tab === 'coupons' }" @click="tab = 'coupons'">
                ...
                Coupons
                <span class="admin-sidebar-badge" style="background:var(--text-muted);"><?php echo e($coupons->count()); ?></span>
            </button>
        </nav>
    ...
    <div class="admin-content">
                    ...
                    <article class="admin-ebook-card">
                        <div class="admin-ebook-cover">
                            <?php if($ebook->cover_image): ?>
                                <img src="<?php echo e($ebook->thumbUrl()); ?>" alt="Couverture — <?php echo e($ebook->title); ?>" loading="lazy" decoding="async">
                            <?php else: ?>
                                    ...
                                    <div style="display:flex;align-items:center;gap:0.4rem;">
                                        ...
                                        <?php if($user->id !== auth()->id()): ?>
                                            <button type="button" class="btn-ghost btn-xs" style="color:var(--cardinal);border-color:var(--cardinal);padding:0.3rem 0.45rem;"
                                                    ...
                                                    @click="openDeleteUser(<?php echo e(json_encode(['name' => $user->name, 'email' => $user->email, 'destroy_url' => route('admin.users.destroy', $user)], JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_TAG)); ?>)">
        ...
        <div x-show="tab === 'coupons'" x-cloak>
                    ...
                    <div class="admin-form-row">
                        <div class="admin-field">
                            ...
                            <select name="ebook_id">
                                ...
                                <?php $__currentLoopData = $ebooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($eb->id); ?>"><?php echo e($eb->title); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
            ...
            <div class="admin-box">
                <div class="admin-box-header"><h3>Coupons existants</h3><span style="font-size:0.82rem;color:var(--text-muted);"><?php echo e($coupons->count()); ?></span></div>
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $coupons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coupon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td><?php echo e($coupon->discount_percent ? $coupon->discount_percent.' %' : number_format($coupon->discount_amount, 2, ',', ' ').' €'); ?></td>
                                    <td style="font-size:0.85rem;"><?php echo e($coupon->ebook?->title ?? 'Global'); ?></td>
                                    <td style="font-size:0.82rem;color:var(--text-secondary);">
                                        <?php echo e(optional($coupon->valid_from)->format('d/m/y')); ?>

                                        <?php if($coupon->valid_until): ?> → <?php echo e($coupon->valid_until->format('d/m/y')); ?> <?php endif; ?>
                                    </td>
                                    <td style="font-size:0.85rem;"><?php echo e($coupon->used_count); ?><?php echo e($coupon->usage_limit ? '/'.$coupon->usage_limit : ''); ?></td>
                                    <td><span class="status-pill <?php echo e($coupon->is_active ? 'paid' : 'pending'); ?>"><?php echo e($coupon->is_active ? 'Actif' : 'Inactif'); ?></span></td>
                                    <td>
                                        <div style="display:flex;gap:0.4rem;">
                                            <form method="POST" action="<?php echo e(route('admin.coupons.toggle', $coupon)); ?>"><?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?><button class="btn-ghost btn-xs" type="submit"><?php echo e($coupon->is_active ? 'Désactiver' : 'Activer'); ?></button></form>
                                            <form method="POST" action="<?php echo e(route('admin.coupons.destroy', $coupon)); ?>" onsubmit="return confirm('Supprimer ce coupon ?')"><?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?><button class="btn-ghost btn-xs" type="submit" style="color:var(--cardinal);border-color:var(--cardinal);">Suppr.</button></form>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
