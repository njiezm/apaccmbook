<?php $__env->startSection('title', 'Lecture — ' . $ebook->title); ?>
...
<section class="reader-shell">
    <div class="container-custom">
        <div class="reader-toolbar">
            <span><?php echo e($ebook->title); ?></span>
    ...
    <div id="reader-wrapper" style="width:min(100%,860px);margin:0 auto;padding:0 1rem;">
        <div class="ebook-reader" id="reader-box" oncontextmenu="return false;">
            ...
            <div id="pdf-error" style="display:none;position:absolute;inset:0;align-items:center;justify-content:center;flex-direction:column;background:#111;color:rgba(255,255,255,0.8);gap:0.75rem;text-align:center;padding:2rem;z-index:11;">
                ...
                <a href="<?php echo e(route('ebooks.mine')); ?>" class="btn-secondary" style="border-color:rgba(255,255,255,0.5);color:white!important;">Retour à ma bibliothèque</a>
            </div>
...
(function () {
    ...
    const pdfUrl = "<?php echo e(route('ebooks.pdf', $ebook)); ?>";
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\apacc-m-ebook\resources\views/ebooks/read.blade.php ENDPATH**/ ?>